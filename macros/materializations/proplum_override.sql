{% materialization proplum, adapter='greenplum' -%}
  ...
  {% if existing_relation is none %}
      ...
      {% else %}
          {# Стандартный init без дедупликации #}
